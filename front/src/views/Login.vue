<template>
  ...
  <div class="half_width_and_center" style="top: 10%">
    <ui5-card style="justify-content: center">
      <div style="width: 50%; margin: 0 auto; justify-content: center; text-align: center">
        <h3 style="color: #00455d;">АИС "Мероприятия ИОХК" </h3>
  ...
  <form ref="login_form"  @submit="formAction">
    <ui5-dialog ref="dialog" class="login-dialog" style="z-index: 16" resizable draggable>
        <ui5-bar slot="header">
        ...
        <div v-if="dialogTitle === 'Вход в систему'" style="display: flex; justify-content: center;">
          <div style="align-self: center">
            <ui5-label required show-colon>Тип входа</ui5-label><br/>
        ...
        <div v-if="dialogTitle === 'Регистрация'" style="display: flex; justify-content: center;">
          <div style="align-self: center">
            ...
            <ui5-label for="reg_sex" required show-colon>Пол</ui5-label><br/>
            <ui5-switch id="reg_sex" ref="reg_sex" text-on="М" text-off="Ж" /><br/>
            ...
            <div v-if="this.selectedRole === 'Преподаватели'">
            ...
            <ui5-label for="reg_personal" required show-colon>
              Согласие на обработку <br/>персональных данных<br/><ui5-button icon="document-text" @click="e => this.$refs.personal_popover.showAt(e.target)">Открыть</ui5-button>
            </ui5-label>
            <ui5-popover ref="personal_popover" placement-type="Top">
              <p style="text-align: justify">
                <b style="text-align: center">Согласие на обработку ПДн</b><br/>
                В соответствии с требованиями статьи 9 Федерального закона от 27 июля 2006 г. № 152-ФЗ «О персональных данных»,
            ...
            <ui5-switch id="reg_personal" ref="reg_personal"
                        @change="e => this.personalAgree = e.target._state.checked"/><br/>

          </div>

        </div>
        <div v-if="dialogTitle === 'Восстановление пароля'" style="display: flex; justify-content: center;">
          <div style="align-self: center">
...
import {removeTableHeaderRow} from "../additional/functions/additional.js";
import {getUrlParameter} from "../additional/functions/cookie.js";
